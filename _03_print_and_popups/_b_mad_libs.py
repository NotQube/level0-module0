...
if __name__ == '__main__':
    ...
    messagebox.showinfo(title="a story",message="If you find yourself having to cross a piranha-infested river, here's how to do it...")


    # Get the player to enter an adjective
    adjective = simpledialog.askstring(title='adjective', prompt="name an adjective")

    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring(title='liquid', prompt="name a type of liquid")

    # Get the player to enter a body part
    body_part = simpledialog.askstring(title='body_part', prompt="name a body part")

    # Get the player to enter a verb
    verb = simpledialog.askstring(title='verb', prompt="name a verb")

    # Get the player to enter a place
    place = simpledialog.askstring(title='place', prompt="name a place")
    ...
    messagebox.showinfo(title="a story",message=story)
